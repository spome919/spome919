...
try:
    with open(filename, 'r') as f:
        data = json.load(f)
        api_id = data['27038918']
        api_hash = data['275e602837ad9a9b1a7f7c68e791560c']
        bot_token = data['6849826411:AAGmPpc3WOyuUAgViSdJJUjeVthMyd-P3Ck']
        DEVLOO = data['DEVLOO']
        MAX_ACCOUNTS = data['MAX_ACCOUNTS']
        user_bot = data['facboktack_bot']
        id_bot = data['6849826411']
